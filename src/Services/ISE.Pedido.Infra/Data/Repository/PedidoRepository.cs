...
namespace ISE.Pedido.Infra.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public async Task<Domain.Pedido> ObterPorId(Guid id)
        {
            return await _context.Pedidos.FindAsync(id);
        }

        public async Task<IEnumerable<Domain.Pedido>> ObterListaPorClienteId(Guid clienteId)
        {
        ...
        public void Atualizar(Domain.Pedido pedido)
        {
