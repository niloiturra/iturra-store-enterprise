...
public class PedidoCommandHandler : CommandHandler,
        IRequestHandler<AdicionarPedidoCommand, ValidationResult>
    {
        ...
        private Domain.Pedido MapearPedido(AdicionarPedidoCommand message)
        {
            ...
            var pedido = new Domain.Pedido(message.ClienteId, message.ValorTotal, message.PedidoItems.Select(PedidoItemDto.ParaPedidoItem).ToList(),
        ...
        private async Task<bool> AplicarVoucher(AdicionarPedidoCommand message, Domain.Pedido pedido)
        {
        ...
        private bool ValidarPedido(Domain.Pedido pedido)
        {
